...
// data returned by get requests of map and mapb commands
...
// data to store location areas stored in LocationAreaList
...
// data for pokemon stored in pokedex after successful catch
type Pokemon struct {
	Abilities []struct {
		Ability struct {
			Name string `json:"name"`
...
// data for pokemon species for catch rate
